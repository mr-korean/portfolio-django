...
urlpatterns = [
    ...
    url(r'^(?P<year>\d{4})/(?P<month>[a-z]{3})/$', NoteMAV.as_view(), name='note_month_archive'),
    url(r'^(?P<year>\d{4})/(?P<month>[a-z]{3})/(?P<day>\d{1,2})/$', NoteDAV.as_view(), name='note_day_archive'),
